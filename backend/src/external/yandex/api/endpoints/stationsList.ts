 ...
 * \`\`\`
 */
export const fetchStationsList = async (params: StationsListParams): Promise<Result<StationsListResponse>> => {
  return makeYandexApiRequest("stations_list", stationsListResponseSchema, params)
}
