...
/**
 * Constructs the full URL with query parameters for logging.
 *
 * @param url - The base URL (endpoint)
 * @param params - The request parameters to be appended as query string
